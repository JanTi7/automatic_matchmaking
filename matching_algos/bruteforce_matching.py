...
class BruteforceMatcher(BaseMatchingAlgo):
    ...
    def _find_matching(self, task_input: TaskInput, run_parallel=True, time_limit=None) -> TaskOutput:
        ...
        if not run_parallel:
            ...
            futures = {executor.submit(get_result, c, constraints, integrality, presolve, mip_rel_gap, time_limit): (presolve, mip_rel_gap)
            ...
            results = concurrent.futures.wait(futures, return_when=concurrent.futures.FIRST_COMPLETED)
