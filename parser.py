...
def get_parser(*default_config_files):
    ...
    parser.add_argument("--pause-mode", choices=["random", "lowest_first"], default="random")
    parser.add_argument("--rubberband", action="store_true")
    parser.add_argument("--rubberband-deviation", type=int, default=200,
    ...
    parser.add_argument("-m", "--matching-algo",

                        choices=["default", "random", "interactive", "scipy",
                                 "studientermin1", "studientermin2", "studientermin3", "studientermin4"],
                        default="default",
                        # required=True
                        )
